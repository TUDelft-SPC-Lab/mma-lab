...
parser.add_argument("feature",
                    help="The type of feature to get results on. Chose from " + str(features))
default_images_folder = os.path.realpath(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), '../Images/joint'))
parser.add_argument("--images",
                    help="The folder used to create the database images. Used for displaying results.",
        ...
        if metadata_distance.has_geotag(metadata):
            ...
            for key in geo_features.keys():
                ...
                if metadata_distance.has_geotag(candidate_metadata):
                    distances.append((key, metadata_distance.compute_geographic_distance(metadata,
                                                                                         candidate_metadata)))
